 ...
 * already have their own dedicated CI jobs (`e2e`, `mcp-integration`,
 * `agent-evals`) that do the real work — re-running them here would just
 * duplicate cost, not add coverage. What's left (install, lint, typecheck,
...
const SKIP_TOKENS = ["dev", "test:e2e", "test:mcp", "eval:agent", "lighthouse"];
