...
describe("getRequestNonce", () => {
  it("reads the x-nonce header middleware.ts set on the current request", async () => {
  ...
  it("returns null when no x-nonce header is present (e.g. an API route the middleware doesn't nonce)", async () => {
